...
class CustomerBase(BaseModel):
    ...
    contact_position: str | None = Field(None, max_length=50, description="客户联系人职位")
...
class CustomerUpdate(BaseModel):
    ...
    address: str | None = Field(None, max_length=200, description="客户地址")
    contact_person: str | None = Field(None, max_length=50, description="客户联系人")
    phone: str | None = Field(None, max_length=20, description="客户联系方式")
    contact_position: str | None = Field(None, max_length=50, description="客户联系人职位")
    remarks: str | None = Field(None, description="备注")
