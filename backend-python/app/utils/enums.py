...
class WorkOrderStatus(str, Enum):
    ...
    def get_valid_statuses(cls) -> list:
        """获取有效状态列表（未完成）"""
        return [cls.IN_PROGRESS.value, cls.PENDING_CONFIRM.value, cls.REJECTED.value]
    ...
    def get_all_statuses(cls) -> list:
        """获取所有状态列表"""
        return [cls.IN_PROGRESS.value, cls.PENDING_CONFIRM.value, cls.COMPLETED.value, cls.REJECTED.value]
