...
def parse_date(date_value: str | date | datetime | None) -> date | None:
    """
    统一的日期解析方法
...
def parse_datetime(datetime_value: str | datetime | None) -> datetime | None:
    """
    统一的日期时间解析方法
...
def format_date(date_value: str | date | datetime | None, fmt: str = '%Y-%m-%d') -> str | None:
    """
    格式化日期为字符串
...
def format_datetime(datetime_value: str | datetime | None, fmt: str = '%Y-%m-%d %H:%M:%S') -> str | None:
    """
    格式化日期时间为字符串
