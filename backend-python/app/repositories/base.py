...
class BaseRepository(Generic[T]):
    ...
    def find_by_id(self, id: int, options: list | None = None) -> T | None:
        """
        根据 ID 查询实体
    ...
    def create(self, entity: T) -> T:
        ...
        注意：此方法只执行flush，不执行commit
        事务管理统一由Service层或get_db()依赖处理
    ...
    def find_by_field(self, field_name: str, value: Any, options: list | None = None) -> T | None:
        """
        根据字段值查询单个实体
