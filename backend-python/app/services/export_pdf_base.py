...
def get_styles():
    ...
    styles.add(ParagraphStyle(
        name='ChineseTitle', fontName=font_name, fontSize=18, leading=24,
        alignment=1, spaceAfter=20, spaceBefore=10, wordWrap='CJK',
    ))
    styles.add(ParagraphStyle(
        name='ChineseNormal', fontName=font_name, fontSize=10, leading=16, wordWrap='CJK',
    ))
    styles.add(ParagraphStyle(
        name='ChineseSection', fontName=font_name, fontSize=12, leading=18,
        spaceBefore=15, spaceAfter=10, textColor=colors.HexColor('#1976d2'), wordWrap='CJK',
    ))
    styles.add(ParagraphStyle(
        name='ChineseContent', fontName=font_name, fontSize=10, leading=16,
        borderPadding=5, wordWrap='CJK',
    ))
    styles.add(ParagraphStyle(
        name='ChineseFooter', fontName=font_name, fontSize=8, leading=12,
        alignment=1, textColor=colors.grey, wordWrap='CJK',
    ))
    styles.add(ParagraphStyle(
        name='ChineseDivider', fontName=font_name, fontSize=12, leading=18,
        alignment=1, spaceBefore=15, spaceAfter=15,
        textColor=colors.HexColor('#666666'), wordWrap='CJK',
    ))
    styles.add(ParagraphStyle(
        name='ChineseNoData', fontName=font_name, fontSize=10, leading=16,
        textColor=colors.HexColor('#999999'), wordWrap='CJK',
    ))
    return styles
...
def _make_cell_paragraph(text: str, styles, cell_style_name: str = 'TableCell') -> Paragraph:
    ...
    cell_style = ParagraphStyle(
        name=cell_style_name, fontName=font_name, fontSize=9,
...
def build_info_table(config_key: str, obj, project=None, styles=None) -> Table:
    ...
    label_style = ParagraphStyle(
        name='InfoLabel', fontName=font_name, fontSize=10,
        leading=14, wordWrap='CJK', alignment=TA_LEFT,
    )
    value_style = ParagraphStyle(
        name='InfoValue', fontName=font_name, fontSize=10,
        leading=14, wordWrap='CJK', alignment=TA_LEFT,
    )
...
def render_logs_section(label: str, logs, styles, elements: list):
    ...
    if logs:
        ...
        header_style = ParagraphStyle(
            name='LogHeader', fontName=font_name, fontSize=9,
            leading=13, wordWrap='CJK', alignment=TA_CENTER,
        )
        log_data = [[
...
def render_workers_section(label: str, workers, styles, elements: list):
    ...
    if workers:
        font_name = get_chinese_font_name()
        header_style = ParagraphStyle(
            name='WorkerHeader', fontName=font_name, fontSize=9,
            leading=13, wordWrap='CJK', alignment=TA_CENTER,
        )
        worker_data = [[
...
def render_inspection_items_section(label: str, inspection_items_data, styles, elements: list):
    ...
    if inspection_items_data:
        font_name = get_chinese_font_name()
        header_style = ParagraphStyle(
            name='ItemHeader', fontName=font_name, fontSize=9,
            leading=13, wordWrap='CJK', alignment=TA_CENTER,
        )
        item_data = [[
            Paragraph("序号", header_style),
...
def render_field_handling_section(label: str, records, styles, elements: list):
    ...
    if records:
        font_name = get_chinese_font_name()
        header_style = ParagraphStyle(
            name='HandlingHeader', fontName=font_name, fontSize=9,
            leading=13, wordWrap='CJK', alignment=TA_CENTER,
        )
        handling_data = [[
