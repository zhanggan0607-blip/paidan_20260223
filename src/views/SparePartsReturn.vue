<template>
  <div class="spare-parts-return-container">
...
export default defineComponent({
  ...
  setup() {
    ...
    const dataList = ref<SparePartsUsageItem[]>([])
    const total = ref(0)
    ...
    const loadData = async () => {
      ...
      try {
        ...
        console.error('加载备品备件归还数据失败:', error)
      } finally {
        loading.value = false
      }
    }
