...
<template>
  <div class="periodic-inspection-page">
    <van-nav-bar title="定期巡检单" fixed placeholder @click-left="handleBack">
      <template #left>
        <div class="nav-left">
              ...
              <div v-for="item in workList" :key="item.id" class="work-card">
                <div class="card-header">
                  ...
                  <div class="work-id-wrapper">
                    <span
                      class="work-id"
                      :style="{ fontSize: getWorkIdFontSize(item.inspection_id) + 'px' }"
                    ...
                    <van-button
                      ...
                      plain
                      class="copy-btn"
                      @click.stop="copyOrderId(item.inspection_id)"
                      >复制单号</van-button
                    >
                  </div>
                </div>
