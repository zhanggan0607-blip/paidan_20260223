...
const quickActions = computed(() => {
  const actions = [
    ...
    { key: 'historyLog', label: '已报维保日志', icon: 'description', color: '#1989fa', route: '/maintenance-log-list', show: userStore.canViewMaintenanceLog() && !userStore.isAdmin() && !userStore.isDepartmentManager() },
    ...
    { key: 'viewAllLog', label: '查看维保日志', icon: 'eye-o', color: '#07c160', route: '/maintenance-log-all', show: userStore.canViewAllMaintenanceLog() },
